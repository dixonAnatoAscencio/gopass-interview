const PATHS: Record<string, string> = {
  ...
  'columns':          '<path d="M12 3h7a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-7M12 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h7M12 3v18"/>',
  ...
  'sparkles':         '<path d="M12 3 10 9l-6 2 6 2 2 6 2-6 6-2-6-2z"/><path d="M19 2l-.5 1.5L17 4l1.5.5L19 6l.5-1.5L21 4l-1.5-.5z"/><path d="M5 18l-.5 1.5L3 20l1.5.5L5 22l.5-1.5L7 20l-1.5-.5z"/>',
  ...
  'chevron-up-down':  '<polyline points="18 15 12 9 6 15"/>',
  'percent':          '<line x1="19" y1="5" x2="5" y2="19"/><circle cx="6.5" cy="6.5" r="2.5"/><circle cx="17.5" cy="17.5" r="2.5"/>',
  'copy':             '<rect x="9" y="9" width="13" height="13" rx="2" ry="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/>',
  'sort-asc':         '<path d="M11 11H3"/><path d="M15 7H3"/><path d="M7 15H3"/><path d="m17 15 4-4-4-4"/><path d="M21 15v4"/>',
...
export function Icon({ name, size = 16, className = '', style = {} }: IconProps) {
  ...
  if (!path) return <span style={{ display: 'inline-block', width: size, height: size, ...style }} className={className} />;
  return (
    <svg
      width={size}
      height={size}
